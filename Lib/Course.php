...
class Course extends JwcBase{
    ...
    protected function spider($pageSize=50,$page=0,$params=[])
    {
        //构造待抓取的URL
        $params_all = [
            'kch' => '',
        ...
        $page = $this->get($url);
        $data = QueryList::Query($page, $rule, '.odd', '','',true)->data;
        return $data;
    }
     ...
     * @return mixed
     */
    public function getCourse($pageSize=50,$page=0){
        return $this->login()->spider($pageSize,$page);
    }

    public function getCourseByteacher($pageSize=50,$page=0,$teacher){

    }

    public function getCourseByName($pageSize=50,$page=0,$name){

    }

    public function getCourseByParams($pageSize=50,$page=0,$params){
